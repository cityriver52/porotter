...
export function createAppsScriptHarness(root, options = {}) {
  ...
  for (const file of [
    'Config.gs', 'Repository.gs', 'Domain.gs', 'SyncService.gs',
    'ReadService.gs', 'PresentationService.gs', 'TimelineService.gs', 'NotificationService.gs',
    'Api.gs', 'Code.gs', 'Studio.gs', 'Automation.gs'
  ]) {
